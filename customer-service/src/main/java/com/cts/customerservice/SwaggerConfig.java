...
public class SwaggerConfig {
	...
	ApiInfo apiInfo = new ApiInfo("CustomerAPI", "To fetch customer details", "1.0", null, contact, null, null,
	...
	public Docket api() {
		...
		return new Docket(DocumentationType.SWAGGER_2).apiInfo(apiInfo).produces(DEFAULT_PRODUCES_AND_CONSUMES)
				...
				.apis(RequestHandlerSelectors.basePackage("com.cts.customerservice")).paths(PathSelectors.any())
				.build();
	}
}
